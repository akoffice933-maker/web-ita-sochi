 ...
 * ИТА Сочи - Калькулятор смет
 */

// База данных (OpenServer по умолчанию)
define('DB_HOST', 'localhost');
define('DB_NAME', 'ita_calculator');
define('DB_USER', 'root');
define('DB_PASS', '');  // В OpenServer пароль пустой
define('DB_CHARSET', 'utf8mb4');

// Настройки приложения
define('APP_NAME', 'Калькулятор смет - ИТА Сочи');
define('APP_URL', 'http://calc.ita-sochi.local/calculator');
define('APP_DEBUG', true);  // true для разработки
